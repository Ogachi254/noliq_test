          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                In 2022, I started Atlanta's go-to mobile non-alcoholic bar—serving bold, beautiful drinks without the booze. My mission was simple: to make the social scene more inclusive, sophisticated, and fun for everyone, regardless of what's in their glass.
              </p>
              ...
              <p className="text-gray-600 mb-6">
                But as my community grew, so did my vision. Today, I've taken everything I loved—connection, culture, curated flavor—and expanded it across the globe through intentional, alcohol-free travel.
              </p>
              <p className="text-gray-600 mb-6">
              ...
              <p className="text-gray-600 mb-6">
                I still love to make a good alc-free cocktail—but now I'm mixing mocktails in Marrakech, not just Midtown. If you're craving adventure, meaning, and community—without the hangover—you're in the right place.
              </p>
